 ...
 *
 * Description:
 * Contains declarations for memory management functions and macros.
 *
 ...
 * divided by
 * @nmemb is less than @size, which is mathematically equivalent but doesn't
 * overflow.
 *
 ...
 * initialized to zero. On failure, it prints an error message to stderr and
